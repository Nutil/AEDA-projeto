...
public:
	...
	float get_base_price(){return this->base_price;}
	float get_cost();
	int get_id(){return this->id;}
	string get_type(){return this->type;}
	void set_base_price(float price){this->base_price = price; return;}
	bool get_audio(){return this->audio;}
	bool get_video(){return this->video;}
	float get_taxa_video(){return this->taxa_video;}
	float get_taxa_audio(){return this->taxa_audio;}
	void set_taxa_video(float taxa_video){this->taxa_video = taxa_video; return;}
	void set_taxa_audio(float taxa_audio){this->taxa_audio = taxa_audio; return;}
};
...
public:
	...
	void set_taxa(float taxa){this->taxa=taxa; return;}
	float get_taxa(){return this->taxa;}
